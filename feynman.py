...
def Feynman():
    ...
    client = OpenAI(api_key=os.environ["OPENAI_API_KEY_SELF"])
    ...
    st.sidebar.markdown(
        """
        The Feynman Technique is a learning method that involves explaining a concept in simple terms, identifying gaps in understanding, and refining the explanation. This approach, named after physicist Richard Feynman, helps deepen comprehension and clarify complex ideas.
        """
    )
    ...
    if prompt := st.chat_input("Try explaining a concept to me"):
